...
export default function Home() {
  ...
  const [showBloodSummary, setShowBloodSummary] = useState(false);
  ...
  return (
    <div className="body">
      ...
      <div className="testResults">
        ...
        <div
          className="testResultWindow shadow"
          onClick={()=>{
            showScanSummary ? setShowScanSummary(false) : setShowScanSummary(true);
          }}
          >
        <p className="h6">Ultrasound Diagnosis</p>
        ...
        <div
          className="testResultWindow shadow"
          onClick={()=>{
            showBloodSummary ? setShowBloodSummary(false) : setShowBloodSummary(true);
        }}>
        <p className="h6">Blood Test Diagnosis</p>
